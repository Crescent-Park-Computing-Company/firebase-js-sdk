...
declare interface KernelCompoundHash {
    posts: string[];
    hashes: string[];
}
 ...
 */
declare interface ListenHashFn {
    (): string;
...
declare interface RowListenHashes {
    hash: string;
    compoundHash: KernelCompoundHash;
}

declare class RowPersistenceManager {
    private prefix_;
    private idbFactory_;
    private webLocks_;
...
declare interface RowRestoreResult {
    node: Node_2 | null;
 ...
 * @internal
 */
export declare interface SeedCompoundHash {
    hashes: string[];
    posts: string[];
}
...
declare interface WebLocksLike {
