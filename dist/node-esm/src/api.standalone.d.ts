...
export { getPersistedValue, getPersistenceAuthScope, onListenOutcome, onPersistenceAuthScopeChanged, setPersistenceEnabled, setPersistenceAuthScope, waitForPersistenceAuthScope } from './api/Database';
